...
const OFFERS_TESTS = [
  ...
  new Offer(3, `Canal View Prinsengracht`, OFFER_TYPES.PRIVATE_ROOM, OFFER_LUXURY_TYPE.NONE, 132, 4.1, false,
      OFFER_DETAILS_IMAGES, DEFAULT_CAPACITY, DEFAULT_FEATURES, HOSTS.ANGELINA, new OfferLocation(`Paris`, 52.3909553943508, 4.929309666406198),
      DEFAULT_DESCRIPTION, REVIEWS, NEAR_PLACES),
  new Offer(4, `Nice, cozy, warm big bed apartment`, OFFER_TYPES.APARTMENT, OFFER_LUXURY_TYPE.NONE, 180, 5, true,
      OFFER_DETAILS_IMAGES, DEFAULT_CAPACITY, DEFAULT_FEATURES, HOSTS.ANGELINA, new OfferLocation(`Paris`, 52.3809553943508, 4.939309666406198),
      DEFAULT_DESCRIPTION, REVIEWS, NEAR_PLACES),
  new Offer(5, `Wood and stone place`, OFFER_TYPES.APARTMENT, OFFER_LUXURY_TYPE.NONE, 80, 2.7, false,
      OFFER_DETAILS_IMAGES, DEFAULT_CAPACITY, DEFAULT_FEATURES, HOSTS.ANGELINA, new OfferLocation(`Cologne`, 52.3819553943508, 4.939319666406198),
      DEFAULT_DESCRIPTION, REVIEWS, NEAR_PLACES),
];
