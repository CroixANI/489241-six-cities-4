...
const OFFERS = [
  ...
  new Offer(6, `Bed in 8 Bed Dorm`, OFFER_TYPES.PRIVATE_ROOM, OFFER_LUXURY_TYPE.NONE, 43, 4, false,
      ...
      DEFAULT_DESCRIPTION, REVIEWS),
  new Offer(7, `Bedroom Paris, close to Montmartre - Gare du Nord`, OFFER_TYPES.APARTMENT, OFFER_LUXURY_TYPE.NONE, 201, 3, true,
      ...
      DEFAULT_DESCRIPTION, REVIEWS),
  new Offer(8, `Appartement Cosy refait à neuf !`, OFFER_TYPES.APARTMENT, OFFER_LUXURY_TYPE.NONE, 179, 4, true,
  ...
  new Offer(9, `La Castellane`, OFFER_TYPES.APARTMENT, OFFER_LUXURY_TYPE.NONE, 500, 5, true,
      ...
      DEFAULT_DESCRIPTION, REVIEWS),
  new Offer(10, `Stone place`, OFFER_TYPES.PRIVATE_ROOM, OFFER_LUXURY_TYPE.NONE, 30, 2, false,
  ...
  new Offer(11, `Modernes Apartment im beliebten Belgischen Viertel`, OFFER_TYPES.PRIVATE_ROOM, OFFER_LUXURY_TYPE.NONE, 51, 4, false,
      ...
      DEFAULT_DESCRIPTION, REVIEWS),
  new Offer(12, `Mdn 3Bed Apt`, OFFER_TYPES.APARTMENT, OFFER_LUXURY_TYPE.NONE, 94, 3, true,
      OFFER_DETAILS_IMAGES, DEFAULT_CAPACITY, DEFAULT_FEATURES, HOSTS.ANGELINA, new OfferLocation(`Cologne`, 52.3849553943508, 4.939309666406198),
      DEFAULT_DESCRIPTION, REVIEWS),
