...
const OFFERS = [
  ...
  new Offer(11, `Modernes Apartment im beliebten Belgischen Viertel`, 51, 4, `Cologne`, `Private room`, ``, false, [{imageUrl: `img/room.jpg`, imageTitle: `Apartment`}]),
  new Offer(12, `Mdn 3Bed Apt`, 94, 3, `Cologne`, `Apartment`, ``, true, [{imageUrl: `img/apartment-01.jpg`, imageTitle: `Apartment`}]),

  new Offer(13, `Bruxelles plein centre`, 44, 4, `Brussels`, `Private room`, ``, false, [{imageUrl: `img/room.jpg`, imageTitle: `Apartment`}]),
  new Offer(14, `Smartflats Monnaie 301 - Duplex 2Bedrooms - Center`, 101, 3, `Brussels`, `Apartment`, ``, true, [{imageUrl: `img/apartment-01.jpg`, imageTitle: `Apartment`}]),

  new Offer(15, `Privatzimmer in HH-Hamm. Schlafen wie ein König`, 44, 4, `Hamburg`, `Private room`, ``, false, [{imageUrl: `img/room.jpg`, imageTitle: `Apartment`}]),
  new Offer(16, `Generator - Deluxe King`, 81, 3, `Hamburg`, `Apartment`, ``, true, [{imageUrl: `img/apartment-01.jpg`, imageTitle: `Apartment`}]),

  new Offer(17, `Ruhiges Appartment in Düsseldorf-Unterbilk`, 35, 4, `Düsseldorf`, `Private room`, ``, false, [{imageUrl: `img/room.jpg`, imageTitle: `Apartment`}]),
  new Offer(18, `Heart of Dus with balcony- charming flat`, 81, 3, `Düsseldorf`, `Apartment`, ``, true, [{imageUrl: `img/apartment-01.jpg`, imageTitle: `Apartment`}])
];
